        ...
        <div class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="contact_maps_url" rows="4" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#47663D] focus:border-[#47663D] font-mono text-sm" placeholder="Tempel URL embed atau seluruh kode iframe dari Google Maps">{{ \App\Models\Setting::getVal('contact_maps_url', '') }}</textarea>
                    <p class="text-xs text-gray-500 mt-1">Di Google Maps: pilih lokasi → Share → Embed a map → salin <strong>URL</strong> (yang dimulai https://www.google.com/maps/embed?pb=...) atau tempel seluruh kode iframe. Jika kosong, hanya tombol &quot;Buka di Google Maps&quot; yang ditampilkan.</p>
                </div>
            </div>
