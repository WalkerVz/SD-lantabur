...
<head>
    <meta charset="utf-8">
    <title>Rekapitulasi Seluruh Pembayaran Kelas</title>
    <style>
...
<body>
    ...
    @foreach($jenis_pembayaran_list as $jenis => $nama_jenis)
        ...
        <div class="{{ $loopCount < $totalItems ? 'page-break' : '' }}">
            <div class="header">
            ...
            <table class="data-table">
                ...
                <tbody>
                    @forelse($siswa_list as $idx => $s)
                        @php
                            $payments = collect($s->pembayaran ?? [])->where('jenis_pembayaran', $jenis)->values();
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="text-center" style="padding: 20px; color: #999;">Belum ada siswa di kelas ini.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
