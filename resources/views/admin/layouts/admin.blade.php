...
<body class="bg-gray-50 min-h-screen" x-data="{
    ...
    settingsOpen: {{ request()->routeIs('admin.settings.index', 'admin.settings.accounts') ? 'true' : 'false' }}
}">
    ...
    <div class="flex min-h-screen">
        ...
        <aside :class="[
            ...
            <nav class="p-4 space-y-1 flex-1 overflow-y-auto">
                ...
                @if(\App\Models\FeatureAccess::can($currentRole, 'dashboard'))
                ...
                @if(\App\Models\FeatureAccess::can($currentRole, 'sdm'))
                ...
                @if(\App\Models\FeatureAccess::can($currentRole, 'siswa'))
                ...
                @if(\App\Models\FeatureAccess::can($currentRole, 'raport'))
                ...
                @if(\App\Models\FeatureAccess::can($currentRole, 'mapel'))
                ...
                @if(\App\Models\FeatureAccess::can($currentRole, 'halaman_depan'))
                ...
                @if(\App\Models\FeatureAccess::can($currentRole, 'settings'))
                <div x-data="{ open: settingsOpen }" @click.away="open = false" class="relative">
                    <button @click="open = !open" type="button" class="w-full flex items-center gap-3 px-4 py-3 rounded-lg {{ request()->routeIs('admin.settings.index', 'admin.settings.accounts') ? 'bg-[#47663D] text-white' : 'text-gray-700 hover:bg-gray-100' }}">
