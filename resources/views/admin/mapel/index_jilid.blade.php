...
<div class="max-w-6xl mx-auto" x-data="jilidPage()">
    <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-8 gap-4">
        <div>
            ...
            <p class="text-gray-600 mt-1 text-sm sm:text-base">Atur materi & urutan Al-Qur'an.</p>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-2 mb-6 flex flex-col overflow-hidden">
        <div class="w-full overflow-x-auto scrollbar-hide">
            <div class="inline-flex gap-1 min-w-max">
                ...
                <a href="{{ route('admin.mapel.jilid') }}" class="px-4 sm:px-6 py-2.5 rounded-xl text-xs sm:text-sm font-bold transition-all bg-[#47663D] text-white shadow-md">Al-Qur'an</a>
            ...
            <table class="w-full text-left">
                <thead class="bg-gray-50 border-b border-gray-100">
                    <tr>
                        ...
                        <th class="px-3 sm:px-6 py-4 text-[10px] sm:text-xs font-bold text-gray-400 uppercase tracking-wider w-24 sm:w-32">Jilid</th>
                ...
                <tbody class="divide-y divide-gray-50">
                    @forelse($items as $m)
                        <tr class="hover:bg-gray-50/50 transition-colors" x-show="activeJilid === 'all' || activeJilid === @js($m->jilid)">
                            ...
                            <td class="px-3 sm:px-6 py-4">
                                <span class="px-2 sm:px-3 py-0.5 sm:py-1 bg-purple-50 text-purple-700 rounded-lg font-bold text-[10px] sm:text-sm block text-center min-w-[50px]">{{ $m->jilid }}</span>
                            </td>
                            <td class="px-3 sm:px-6 py-4">
