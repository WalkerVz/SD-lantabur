...
<div class="max-w-6xl mx-auto" x-data="tahfidzPage()">
    <div class="flex items-center justify-between mb-8">
        <div>
            ...
            <p class="text-gray-600 mt-1">Atur materi Tahfidz Ummi dan urutan.</p>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-2 mb-6 flex flex-col">
        <div class="inline-flex gap-1">
            ...
            <a href="{{ route('admin.mapel.jilid') }}" class="px-6 py-2.5 rounded-xl text-sm font-bold transition-all text-gray-500 hover:bg-gray-50">Al-Qur'an</a>
            <a href="{{ route('admin.mapel.tahfidz') }}" class="px-6 py-2.5 rounded-xl text-sm font-bold transition-all bg-[#47663D] text-white shadow-md">Materi Tahfidz</a>
        </div>
            ...
            <table class="w-full text-left">
                <thead class="bg-gray-50 border-b border-gray-100">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-xs font-bold text-gray-400 uppercase tracking-wider w-40">Jilid</th>
                        <th class="px-6 py-4 text-xs font-bold text-gray-400 uppercase tracking-wider">Materi / Surat</th>
                ...
                <tbody class="divide-y divide-gray-50">
                    @forelse($items as $m)
                        <tr class="hover:bg-gray-50/50 transition-colors" x-show="activeJilid === 'all' || activeJilid === @js($m->jilid)">
                            ...
                            <td class="px-6 py-4">
                                <span class="px-3 py-1 bg-cyan-50 text-cyan-700 rounded-lg font-bold text-sm">{{ $m->jilid }}</span>
                            </td>
