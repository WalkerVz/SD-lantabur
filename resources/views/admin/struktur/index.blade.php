...
<div class="max-w-7xl mx-auto" x-data="strukturPage()">
    ...
    <div class="flex flex-wrap gap-2 mb-4 border-b border-gray-200">
        <a href="{{ route('admin.sdm.index') }}" class="px-4 py-3 rounded-t-lg {{ request()->routeIs('admin.sdm.*') ? 'bg-gray-100 text-gray-700 hover:bg-gray-200' : 'bg-[#47663D] text-white' }}">
    ...
    <div class="bg-white rounded-xl shadow border border-gray-100 p-4 mb-4 flex justify-end">
        <div class="flex gap-2">
            <a href="{{ route('admin.struktur.export.pdf') }}" class="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 text-sm font-medium inline-flex items-center gap-2">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                Export PDF
            </a>
            <button type="button" @click="openFormModal(null)" class="px-4 py-2 bg-[#47663D] text-white rounded-lg hover:bg-[#5a7d52] text-sm font-medium">+ Tambah Struktur</button>
        </div>
    </div>
