...
<div class="max-w-2xl mx-auto">
    ...
    <form action="{{ $item ? route('admin.struktur.update', $item->id) : route('admin.struktur.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-xl shadow border border-gray-100 p-6">
        @csrf
