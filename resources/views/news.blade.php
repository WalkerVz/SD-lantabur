...
@section('content')
    ...
    <section class="bg-gradient-to-r from-green-700 to-green-800 text-white py-24 px-5">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <p class="text-xl text-green-100">Dapatkan update terbaru dari SD Al-Qur'an Lantabur</p>
        </div>
    </section>
    ...
    <section class="py-24 px-5 bg-white">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="mb-12 flex gap-4 flex-wrap justify-center">
                <input type="text" placeholder="Cari berita..." class="px-6 py-3 border-2 border-green-300 rounded-lg focus:outline-none focus:border-green-700 transition w-full md:w-64">
                <select class="px-6 py-3 border-2 border-green-300 rounded-lg focus:outline-none focus:border-green-700 transition">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {{-- News Card 1 --}}
                <article class="bg-white rounded-lg shadow-md hover:shadow-xl transition overflow-hidden border-t-4 border-green-700">
                    <div class="bg-gradient-to-br from-green-500 to-green-700 h-48 flex items-center justify-center text-white">
                        <div class="text-6xl">📚</div>
                    </div>
                    <div class="p-6">
                        <div class="flex items-center gap-2 mb-3">
                            <span class="text-xs bg-green-100 text-green-800 px-3 py-1 rounded-full font-semibold">Akademik</span>
                            <span class="text-xs text-gray-500">23 Januari 2026</span>
                        </div>
                        <h3 class="text-2xl font-bold text-green-800 mb-3">Peluncuran Program Literasi Digital</h3>
                        ...
                        <a href="#" class="text-green-700 font-semibold hover:text-green-800 transition">Baca Selengkapnya →</a>
                    </div>
                </article>
                ...
                <article class="bg-white rounded-lg shadow-md hover:shadow-xl transition overflow-hidden border-t-4 border-green-700">
                    ...
                    <div class="p-6">
                        ...
                        <h3 class="text-2xl font-bold text-green-800 mb-3">Juara Lomba Cerdas Cermat Tingkat Kabupaten</h3>
                ...
                <article class="bg-white rounded-lg shadow-md hover:shadow-xl transition overflow-hidden border-t-4 border-green-700">
                    ...
                    <div class="p-6">
                        ...
                        <h3 class="text-2xl font-bold text-green-800 mb-3">Perayaan Tahun Baru Imlek 2577</h3>
                ...
                <article class="bg-white rounded-lg shadow-md hover:shadow-xl transition overflow-hidden border-t-4 border-green-700">
                    ...
                    <div class="p-6">
                        ...
                        <h3 class="text-2xl font-bold text-green-800 mb-3">Pendaftaran Siswa Baru Tahun Ajaran 2026/2027</h3>
                ...
                <article class="bg-white rounded-lg shadow-md hover:shadow-xl transition overflow-hidden border-t-4 border-green-700">
                    ...
                    <div class="p-6">
                        ...
                        <h3 class="text-2xl font-bold text-green-800 mb-3">Kunjungan Edukatif ke Museum Nasional</h3>
                ...
                <article class="bg-white rounded-lg shadow-md hover:shadow-xl transition overflow-hidden border-t-4 border-green-700">
                    ...
                    <div class="p-6">
                        ...
                        <h3 class="text-2xl font-bold text-green-800 mb-3">Turnamen Futsal Antar Kelas Tahun 2026</h3>
            ...
            <div class="flex justify-center gap-2 mt-16">
                <button class="px-4 py-2 bg-green-700 text-white rounded-lg hover:bg-green-800 transition font-semibold">1</button>
                <button class="px-4 py-2 border-2 border-green-700 text-green-700 rounded-lg hover:bg-green-50 transition">2</button>
                <button class="px-4 py-2 border-2 border-green-700 text-green-700 rounded-lg hover:bg-green-50 transition">3</button>
                <button class="px-4 py-2 border-2 border-green-700 text-green-700 rounded-lg hover:bg-green-50 transition">Selanjutnya →</button>
            </div>
        </div>
    </section>

    {{-- Newsletter Signup --}}
    <section class="bg-green-50 py-16 px-5">
        <div class="max-w-2xl mx-auto text-center">
            <h2 class="text-3xl font-bold text-green-800 mb-4">Dapatkan Berita Terbaru</h2>
            ...
            <div class="flex gap-3 flex-col sm:flex-row">
                <input type="email" placeholder="Masukkan email Anda" class="flex-1 px-4 py-3 border-2 border-green-300 rounded-lg focus:outline-none focus:border-green-700 transition">
                <button class="px-8 py-3 bg-green-700 text-white font-bold rounded-lg hover:bg-green-800 transition">Subscribe</button>
            </div>
        </div>
    </section>
    ...
    <section class="bg-gradient-to-r from-green-700 to-emerald-900 py-20 px-5 text-center text-white">
        ...
        <p class="text-xl mb-10 text-green-100">Hubungi kami untuk informasi lebih lanjut</p>
