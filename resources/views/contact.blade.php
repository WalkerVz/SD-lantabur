...
@section('content')
    ...
    <section class="bg-gradient-to-r from-[#47663D] to-[#47663D] text-white py-16 md:py-24 px-5 border-b-4 border-[#FFB81C]">
        <div class="max-w-4xl mx-auto text-center">
            <h1 class="text-3xl md:text-5xl font-bold mb-4 md:mb-6">Hubungi Kami</h1>
            <p class="text-lg md:text-xl text-white/60">Kami siap menjawab pertanyaan dan membantu Anda</p>
        </div>
    </section>
    ...
    @endphp
    <section class="py-12 md:py-24 px-5 bg-gray-50">
        <div class="max-w-6xl mx-auto">
            <div class="text-center mb-8 md:mb-12">
                <p class="text-[#FFB81C] text-xl md:text-2xl ornament-text mb-2 md:mb-4">✦ ✦ ✦</p>
                <h2 class="text-3xl md:text-5xl font-bold text-[#47663D] mb-3 md:mb-4">Lokasi Kami</h2>
                <p class="text-gray-600 text-base md:text-lg italic">Temukan kami di peta</p>
            </div>
    ...
    {{-- CONTACT INFO --}}
    <section class="py-12 md:py-24 px-5 bg-white">
        <div class="max-w-6xl mx-auto">
            <div class="space-y-6 md:space-y-8">
                    <h2 class="text-2xl md:text-3xl font-bold text-[#47663D] mb-6 md:mb-8 text-center md:text-left">Informasi Kontak</h2>
                    
                    <div class="bg-white p-6 md:p-8 rounded-xl border-l-4 border-[#FFB81C] shadow-md hover:shadow-lg transition">
                        <h3 class="text-lg md:text-xl font-bold text-[#47663D] mb-2 md:mb-3 flex items-center gap-2"><span class="text-xl md:text-2xl">📍</span> Alamat</h3>
                    ...
                    <div class="bg-white p-6 md:p-8 rounded-xl border-l-4 border-[#FFB81C] shadow-md hover:shadow-lg transition">
                        <h3 class="text-lg md:text-xl font-bold text-[#47663D] mb-2 md:mb-3 flex items-center gap-2"><i class="fa-brands fa-whatsapp text-green-500 text-xl md:text-2xl"></i> Telepon / WhatsApp</h3>
                        <div class="space-y-3">
                            <p class="text-gray-700 text-base md:text-lg flex flex-wrap items-center gap-2">
                                ...
                                <span class="bg-[#47663D]/10 text-[#47663D] text-[10px] md:text-xs px-2 py-1 rounded-md mt-1 md:mt-0">{{ \App\Models\Setting::getVal('contact_name', 'Admin') }}</span>
                            </p>
                            
                            @if(\App\Models\Setting::getVal('contact_phone_2'))
                            <p class="text-gray-700 text-base md:text-lg flex flex-wrap items-center gap-2 border-t pt-3">
                                ...
                                <span class="bg-[#47663D]/10 text-[#47663D] text-[10px] md:text-xs px-2 py-1 rounded-md mt-1 md:mt-0">{{ \App\Models\Setting::getVal('contact_name_2', 'TU') }}</span>
                            </p>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-6 md:p-8 rounded-xl border-l-4 border-[#FFB81C] shadow-md hover:shadow-lg transition">
                        <h3 class="text-lg md:text-xl font-bold text-[#47663D] mb-2 md:mb-3 flex items-center gap-2"><span class="text-xl md:text-2xl">✉️</span> Email</h3>
                        <p class="text-gray-700 text-sm md:text-lg break-words">
                    ...
                    <div class="bg-white p-6 md:p-8 rounded-xl border-l-4 border-[#FFB81C] shadow-md hover:shadow-lg transition">
                        <h3 class="text-lg md:text-xl font-bold text-[#47663D] mb-2 md:mb-3 flex items-center gap-2"><span class="text-xl md:text-2xl">⏰</span> Jam Operasional</h3>
                        <p class="text-gray-700 text-sm md:text-base">
    ...
    <section class="bg-gradient-to-r from-[#47663D] via-[#5a7d52] to-[#47663D] py-16 md:py-24 px-5 text-center text-white border-t-4 border-b-4 border-[#FFB81C]">
        ...
        <h2 class="text-3xl md:text-5xl font-bold mb-4 md:mb-6">Terhubung Dengan Kami</h2>
