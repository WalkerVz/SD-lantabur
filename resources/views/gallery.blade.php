            ...
            @else
                ...
                @else
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="bg-white rounded-xl shadow-md hover:shadow-xl transition border-2 border-[#FFB81C]/30 overflow-hidden group flex flex-col">
                            {{-- Embed YouTube --}}
                            ...
                            <div class="p-4 flex-1 flex flex-col">
                                ...
                                <div class="mt-auto pt-4">
                                    <a href="https://www.youtube.com/watch?v={{ $video->youtube_id }}" 
                                       target="_blank" 
                                       class="inline-flex items-center gap-1.5 text-xs font-bold text-red-600 hover:text-red-700 transition">
